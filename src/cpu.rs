...
impl<C: BusInterface> Olc6502<C> {
    ...
    pub fn read(&self, bus: &mut C, addr: u16) -> u8 {
    ...
    pub fn write(&self, bus: &mut C, addr: u16, data: u8) {
        bus.write(addr, data)
    }
    ...
    pub fn trace(&self, bus: &mut C) -> String {
    ...
    pub fn reset(&mut self, bus: &mut C) {
        self.a      = 0; 
        self.x      = 0;
        self.y      = 0; 
        self.stkp   = 0xFD; 
    ...
    pub fn clock(&mut self, bus: &mut C) {
    ...
    pub fn step_instruction(&mut self, bus: &mut C) {
    ...
    pub fn fetch(&mut self, bus: &mut C) -> u8 {
        let inst = LOOKUP[self.opcode as usize];
    ...
    fn xxx(&mut self, _bus: &mut C) -> u8 { 0 }
